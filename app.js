...
function sendEmail() {
    ...
    Email.send({
        ...
        Username: "rutvisavaliya16@gmail.com",
        Password: "Tiger_1610",
        To: "rutvisavaliya16@gmail.com",
        From: "rutvisavaliya16@gmail.com",
        Subject: sub.value,
        Body: bodyMesg,
    }).then((message) =>
